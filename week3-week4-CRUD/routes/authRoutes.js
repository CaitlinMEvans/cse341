...
router.get("/dashboard", (req, res) => {
  ...
  if (role === "professor") {
    ...
    buttons += `
      <a class="btn" href="/api/hogwarts-professors" target="_blank">View Professors</a>
      <a class="btn" href="/api/hogwarts-students" target="_blank">View Students</a>
    `;
  }

  // Add Swagger button for both professor and headmaster
  if (role === "professor" || role === "headmaster") {
    buttons += `<a class="btn" href="/api-docs" target="_blank">Swagger API Docs</a>`;
  }
